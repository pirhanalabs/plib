...
class Tween
{
	 ...
	 * usage
	 * 
	 *      Tween.lerp(0, 5, time/timemax)
	 *      Tween.lerp(0, 5, Tween.outElastic(time/timemax))
	 * 
	 * @param a start value
	 * @param b end value
	...
	/**
		Custom spike to have different behavior in two halves.
		Note: the 2nd half is flipped.
	**/
